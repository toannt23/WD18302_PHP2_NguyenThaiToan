...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th2 07, 2024 lúc 02:30 PM
...
CREATE TABLE `assignments` (
  ...
  `status` enum('Đang thực hiện','Đã hoàn thành','Chưa hoàn thành') COLLATE utf8mb4_general_ci NOT NULL
...
INSERT INTO `assignments` (`id`, `creatd_at`, `tasks_id`, `users_id`, `status`) VALUES
(1, '2024-02-07', 1, 2, 'Đang thực hiện');
...
CREATE TABLE `tasks` (
  ...
  `status` enum('Task đang mở','Task đã đóng') COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tasks` (`id`, `name`, `description`, `dealine`, `status`) VALUES
(1, 'Xây dựng API cho quản lý người dùng', 'Phát triển các endpoint RESTful để thêm, sửa, xóa người dùng', '2024-02-09', 'Task đang mở'),
(2, 'Giao diện', 'Xây dựng giao diện Login ', '2024-02-10', 'Task đang mở'),
(3, 'Giao diện', 'Xây dựng giao diện Login ', '2024-02-10', 'Task đang mở');
